...
# Update Room.updated when a new message is sent or an existing message is deleted
...
# Update Room.updated when a participant is added or removed
...
def update_room_on_participant_change(sender, instance, action, **kwargs):
    if action in ["post_add", "post_remove"]:
        instance.updated = instance.updated  # This triggers auto_now=True
        instance.save()
